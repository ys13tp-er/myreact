...
class problem extends Component {
    ...
    getProData = () => {
        ...
        React.$axios.get(
            "http://localhost:3000/qfmdb/gituserProblem",
            {
                params: {
        ...
        if (this.state.ProblemValue) {
            Modal.confirm({
                ...
                onOk: () => {
                    ...
                    // console.log(times);
                    // 发送请求提交
                    React.$axios.post('http://localhost:3000/qfmdb/insertUP', qs.stringify({
                        username: this.state.username,
                        usernumb: this.state.usernumb,
                        pro: this.state.ProblemValue,
                        times: times,
                        resss: ''
                    }))
                        .then(res => {
